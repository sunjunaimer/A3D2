...
class Options():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--weight_decay', type=float, default=0.0001, help='weight decay when training')
        ...
        parser.add_argument('--dataset_mode_t', type=str, default='multimodal', help='chooses how target datasets are loaded. [iemocap, ami, mix]')
        parser.add_argument('--num_threads', default=6, type=int, help='# threads for loading data')
        parser.add_argument('--batch_size', type=int, default=128, help='input batch size')
        parser.add_argument('--serial_batches', default=0, type=bool)#action='store_true', help='if true, takes images in order to make batches, otherwise takes them randomly')
        ...
        parser.add_argument('--weights', type=float, nargs='+', required=True, help='A list of float weights')

        # expr setting 
        parser.add_argument('--run_idx', type=int, default=1, help='experiment number; for repeat experiment')
        parser.add_argument('--cof_weight', type=int)
        parser.add_argument('--disc_test', type=bool, default=False)
        parser.add_argument('--target', type=str)
        parser.add_argument('--source', type=str)
        parser.add_argument('--train_id', type=str)
        parser.add_argument('--train_id_t', type=str)
        parser.add_argument('--domain', type=str)
        #parser.add_argument('--datasets_folder', default='../d2d_data', type=str)
        parser.add_argument('--datasets_folder', default='../d2d_data', type=str)
        ...
        parser.add_argument('--csv_name', default='label.csv', type=str, help='the name of lable.csv')
        parser.add_argument('--tmp_weight', default='-1 1 0', type=str, help='a v l - weight')  # 默认的是不进行处理
        parser.add_argument('--change_weight1', default='-1 1 0', type=str, help='a v l - weight')
        parser.add_argument('--change_weight2', default='-1 1 0', type=str, help='a v l - weight')
        parser.add_argument('--change_weight3', default='-1 1 0', type=str, help='a v l - weight')
